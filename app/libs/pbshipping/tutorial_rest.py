...
# Constants
#-------------------------------------------------------------------------------
from app.utils import timed_cache
...
#-------------------------------------------------------------------------------
@timed_cache(hours=10)
def authenticate_and_authorize(api_key, api_secret, token=None):
    global _pb_oauth_params
    if token:
        _pb_oauth_params = token
        return _pb_oauth_params
...
if __name__ == '__main__':
    print(authenticate_and_authorize('jznzfxkvgOGyboy5oroqZN1nRfh0SwVM', 'V6aptMhFsV46tnaP'))
    # print(getPbTxId())
